...
## More from BetterTyped

Do you like this library? Here is what else we build and maintain:

- [Hype Stack](https://hype-stack.dev) — a full-stack TypeScript template with
  installable feature packs, so you can ship a SaaS in days instead of months.
- [HyperFetch](https://hyperfetch.bettertyped.com) — type-safe data fetching
  and realtime for any framework.
- [BetterTyped](https://bettertyped.com) — the open source collective behind
  these projects.
